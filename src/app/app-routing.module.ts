...
const routes: Routes = [
  ...
  {
    path: 'myorderdetails',
    loadChildren: () => import('./myorderdetails/myorderdetails.module').then( m => m.MyorderdetailsPageModule)
  },
  {
  ...
  {
    path: 'passwordotp',
    loadChildren: () => import('./passwordotp/passwordotp.module').then( m => m.PasswordotpPageModule)
  },
  {
    path: 'passwordreset',
